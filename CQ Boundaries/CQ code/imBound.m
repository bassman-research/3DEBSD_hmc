...
%% While The User is Unhappy about Life
isgood = 0;
while isgood == 0
    ...
    patternChoices = zeros(numTrials,maxPatterns);
    ...
    for trial = 1:numTrials
        ...
        for i=2:numel(unique_colors)/3
            ...
            if size(b)>0
                ...
                patternChoices(trial,patternCounter) = i; 
                subplot(numTrials,maxPatterns,(trial-1)*maxPatterns+patternCounter),...
                    subimage(X)
                Vaxis = axis;
